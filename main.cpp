...
struct spherical_harmonics
{
    ...
    void operator () (std::ostream & sh, std::ostream & ps)
    {
        ...
        }
        {
            ...
            ps << "EOD\n";
            constexpr size_type const tstrip[NVERTICES] = {0, 4, 5, 3, 11, 19, 13, 7, 2, 10, 8, 16, 12, 6, 1, 9, 17, 15, 14, 18};
            //constexpr size_type const pstrip[2 + NVERTICES] = {1, 4, 0, 6, 11, 7, 2, 9, 0, 4, 5, 8, 3, 10, 1, 6, 7, 3, 2, 5, 9};
            ps << "$strip << EOD\n";
            for (auto const i : tstrip) {
                print(cfaces[i], 0);
            }
            ps << "EOD\n";
